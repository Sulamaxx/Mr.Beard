...
import './ApparelProducts.scss';
import apparelBgImage from '/src/assets/images/products/product-top-name-bg.png';
...
const ApparelProducts: React.FC = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        setLoading(true);
        // Send POST request with 'Apparel' as static category using ApiService
  ...
  return (
    <div className="apparel-products-page mt-3">
      ...
      <div className="hero-section" style={{ backgroundImage: `url(${apparelBgImage})` }}>
        <h1>Apparel</h1>
      </div>
